        ...
        with st.spinner("Pensando..."):
            ...
            # ========================================================
                ...
                if pergunta.lower() in ["sim", "s", "yes"]:
                    ...
                    st.session_state.acao_atual = "coletar_email"
                else:
            ...
            # ========================================================
                ...
                if pergunta.lower() in ["sim", "s", "yes"]:
                    ...
                    if cnpj_envio and email_copia:
                        sucesso = enviar_email_cadastro(
                            cnpj=cnpj_envio,
                            solicitante="Usuário ChatBot",
                            destino="leonardo.campos@rigarr.com.br",
                            copia=email_copia
                        )
                        if sucesso:
                            st.markdown(f"✅ E-mail enviado com sucesso! CNPJ: {cnpj_envio}")
                        else:
                            st.markdown("❌ Falha ao enviar o e-mail.")
                    else:
                        st.markdown("❌ Dados insuficientes para envio.")
